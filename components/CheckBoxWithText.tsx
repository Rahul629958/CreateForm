...
export default function CheckBoxWithText(props: any) {
  return (
    <>
      <div
        className={
          "row cursor-pointer align-middle content-center h-14 rounded-2xl border-t border-b mr-4 mb-2 text-[1.1rem] " +
          (props.obj.isSelected
      ...
      >
        <div onClick={(e) => props.func(!props.obj.isSelected)} className="row">
          <div className="col-sm-2 col-md-2 col-lg-2 col-xs-2">
            <input
              type="checkbox"
              checked={props.obj.isSelected}
              onChange={(e) => props.func(!props.obj.isSelected)}
            />
          </div>
